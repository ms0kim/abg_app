            ...
            >
                ...
                <div className="overflow-y-auto max-h-80 divide-y divide-gray-100">
                    {places.map((place, index) => {
                        ...
                        const bgColor = isOpen ? (isHospital ? 'bg-rose-50' : 'bg-emerald-50') : 'bg-gray-50';
                        const textColor = openStatus === 'open'
                            ? (isHospital ? 'text-rose-600' : 'text-emerald-600')
                            : openStatus === 'holiday' ? 'text-amber-600' : 'text-gray-600';
                        const iconBg = isOpen ? (isHospital ? 'bg-rose-500' : 'bg-emerald-500') : 'bg-gray-400';
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-xs text-gray-600 mt-0.5 truncate">{place.address}</div>
